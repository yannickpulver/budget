...
function TooltipContent({
  ...
  > & {
    /** "dark" is the default single-line pill; "light" matches the app's popover styling for denser content. */
    variant?: "dark" | "light"
    showArrow?: boolean
  }) {
  return (
          ...
          {showArrow && (
            <TooltipPrimitive.Arrow
              className={cn(
                ...
                variant === "dark" ? "bg-foreground fill-foreground" : "bg-popover fill-popover"
              )}
            />
          )}
        </TooltipPrimitive.Popup>
