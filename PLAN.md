...
- Transfers: payee `Transfer : <Account>`, two rows. Both-on-budget → category blank both sides. To tracking account → on-budget side categorized (e.g. `5. Saving / Investing: Brokerage`).
